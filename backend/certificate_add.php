        ...
        <div class="col-xs-12">
          <form id="add_certificate_form">
            ...
            <div class="form-group">
              ...
              <input type="input" class="form-control" id="serial_number"></input>
            </div>

            <div class="form-group">
              <label for="score">分數 </label>
              <input type="input" class="form-control" id="score"></input>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="hidden" id="pdf_path" value="">
    ...
    $(document).on("ready", function() {
      ...
      $("#add_certificate_form").on("submit", function() {
        ...
        if ($("#name").val() == '') {
          ...
          $.ajax({
            type: "POST",
            url: "../php/add_certificate.php", //因為此檔案是放在 admin 資料夾內，若要前往 php，就要回上一層 ../ 找到 php 才能進入 add_certificate.php
            data: {
              name: $("#name").val(), //名稱
