          ...
          <form id="add_article_form">
            ...
            <div class="form-group">
              ...
              <label class="radio-inline">
                <input type="radio" name="category" value="專案" checked>
                專案 </label>
              <label class="radio-inline">
                <input type="radio" name="category" value="IG影片">
                IG影片 </label>
              <label class="radio-inline">
                <input type="radio" name="category" value="YouTube影片">
                YouTube影片 </label>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="input" class="form-control" id="team"></input>
            </div>

            <div class="form-group">
              <label for="teacher">指導老師 </label>
              <input type="input" class="form-control" id="teacher"></input>
            </div>

            <div class="form-group">
              <label for="website">網站(假如為影片必須選擇嵌入式網址) </label>
              <input type="input" class="form-control" id="website"></input>
            </div>

            <div class="form-group">
              <label for="technology">技術 </label>
              <input type="input" class="form-control" id="technology"></input>
            </div>
