...
<body>
        ...
        <div class="col-xs-12">
          <form id="add_experience_form">
            ...
            <div class="form-group">
              ...
              <textarea type="input" class="form-control" id="subtitle"></textarea>
            </div>
  ...
  <script>
    $(document).on("ready", function() {
      ...
      //表單送出
      $("#add_experience_form").on("submit", function() {
        //加入loading icon
        ...
        if ($("#title").val() == '') {
          ...
          $.ajax({
            type: "POST",
            url: "../php/add_experience.php", //因為此檔案是放在 admin 資料夾內，若要前往 php，就要回上一層 ../ 找到 php 才能進入 add_article.php
            data: {
              title: $("#title").val(), //標題
