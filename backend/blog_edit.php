          ...
          <form id="edit_blog_form">
            ...
            <div class="form-group">
              ...
              <label class="radio-inline">
                <input type="radio" name="category" value="頒獎" <?php echo ($data['category'] == "頒獎") ? "checked" : ""; ?>>
                頒獎 </label>
              <label class="radio-inline">
                <input type="radio" name="category" value="活動" <?php echo ($data['category'] == "活動") ? "checked" : ""; ?>>
                活動 </label>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="input" class="form-control" id="people" value="<?php echo $data['people']; ?>"></input>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="hidden" id="image_path2" value="<?php echo $data['pic']; ?>">
              <div class="image" id="image1">
                <?php if ($data['pic'] && file_exists("../" . $data['pic'])) : ?>
